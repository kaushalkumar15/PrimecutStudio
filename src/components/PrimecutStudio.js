...
const PrimecutStudio = () => {
    ...
    const openEmail = () => {
     ...
     const openTwitter = () => {
        window.open("https://x.com/StudiosPrimecut", "_blank");
    };
        ...
        <div className="min-h-screen bg-black text-white overflow-hidden">
            ...
            <div id="contact-section" className="px-4 md:px-8 py-20 bg-black text-center">
                ...
                <div className="flex flex-col md:flex-row gap-4 justify-center">
                    ...
                    <Button onClick={openEmail} className="text-lg px-6 py-3 !bg-green-700 hover:!bg-green-800 rounded-2xl text-white font-semibold flex items-center justify-center">
                        <FaEnvelope className="mr-2 text-2xl" /> Email Us
                    </Button>
                    <Button onClick={openTwitter} 
                        className="text-lg px-10 py-3 bg-blue-600 hover:bg-blue-800 rounded-2xl text-white font-semibold flex items-center justify-center transition-colors duration-300"
                        >
